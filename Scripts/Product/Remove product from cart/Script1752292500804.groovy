...
WebUI.waitForElementClickable(findTestObject('Object Repository/Product Page/button_Add to cart_backpack'), 10)
...
WebUI.waitForElementVisible(findTestObject('Product Page/span_Your Cart'), 5)

WebUI.waitForElementVisible(findTestObject('Object Repository/Product Page/div_1Sauce Labs Backpackcarry.allTheThings(_948477'), 
    5)

WebUI.click(findTestObject('Product Page/button_Remove_backpack'))

WebUI.verifyElementNotVisible(findTestObject('Product Page/div_1Sauce Labs Backpackcarry.allTheThings(_948477'))
